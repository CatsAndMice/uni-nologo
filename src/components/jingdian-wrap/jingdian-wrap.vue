<template>
	<view>
		<view class="bg-img m-bg radius flex justify-between padding"
			...
			<view class="margin-auto-tb flex flex-direction">
				<button @click="clickToApplyCommend" class="cu-btn radius  bg-white theme-color">获取晶点</button>
				<button @click="clickToShop" class="cu-btn radius  line-white margin-top">礼品中心</button>
			</view>
		</view>
	</view>
</template>
